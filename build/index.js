...
const t=JSON.parse('{"_":[{"name":"pipedrive_reach_counter","patterns":["https://santeacademie.pipedrive.com{/path*}"],"action":"Pipedrive:ReachCounter","debug":false}]}');
