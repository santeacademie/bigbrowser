...
declare abstract class TamperController {
    ...
    checkFor: (checkKey: string, readyCallback: () => boolean, processCallback: (elementMarker: ElementMarkerCallback) => PresencePayloadInterface | null, ms?: number | undefined, maxAge?: number | undefined, mount?: ((payload: PresencePayloadInterface) => void) | undefined, unmount?: ((payload: PresencePayloadInterface) => void) | undefined) => void;
