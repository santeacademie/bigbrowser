...
/* harmony export */ });
/* harmony import */ var _TamperController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../TamperController */ "./src/lib/controller/TamperController.ts");
...
var ReachCounter = /*#__PURE__*/function (_TamperController) {
  ...
  function ReachCounter() {
    ...
    _defineProperty(_assertThisInitialized(_this), "hashTryReachField", 'a9a1a17c4397010006c2aa550dca0cab13ed3419');

    _defineProperty(_assertThisInitialized(_this), "run", function (request) {
      _this._injectScript();

      setTimeout(function () {
        _this.launchTryReach();
      }, 500);
    });

    _defineProperty(_assertThisInitialized(_this), "_injectScript", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "launchTryReach", function () {
      ...
      $body.on('click', 'td[data-field="' + _this.hashTryReachField + '"].gridRow__cell:not(".gridRow__cell--editing") button', function () {
        setTimeout(function () {
          _this.addButtonToPopover();
        }, 200);
      });
      $body.on('click', '.sub-one-tryreach', function () {
        _this.subOneTryReach(jQuery(_assertThisInitialized(_this)).closest('.item'));
      });
      $body.on('click', '.add-one-tryreach', function () {
        _this.addOneTryReach(jQuery(_assertThisInitialized(_this)).closest('.item'));
      });
    });

    _defineProperty(_assertThisInitialized(_this), "addButtonToPopover", function () {
      var $item = jQuery('.changeFieldValue.' + _this.hashTryReachField + ' .item');
    ...
    _defineProperty(_assertThisInitialized(_this), "subOneTryReach", function ($item) {
      var $select = $item.find('select[name="' + _this.hashTryReachField + '"]');
    ...
    _defineProperty(_assertThisInitialized(_this), "addOneTryReach", function ($item) {
      var $select = $item.find('select[name="' + _this.hashTryReachField + '"]');
      var index = $select.prop('selectedIndex');
...
}(_TamperController__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ReachCounter);

/***/ }),

/***/ "./src/lib/controller/Pipedrive/ReachCounter/ReachCounter2.ts":
/*!********************************************************************!*\
  !*** ./src/lib/controller/Pipedrive/ReachCounter/ReachCounter2.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ReachCounter2 = /*#__PURE__*/function (_TamperController) {
  _inherits(ReachCounter2, _TamperController);

  var _super = _createSuper(ReachCounter2);

  function ReachCounter2() {
    var _this;

    _classCallCheck(this, ReachCounter2);
    ...
    _defineProperty(_assertThisInitialized(_this), "run", function (request) {
      ...
      var hashTryReachField = 'a9a1a17c4397010006c2aa550dca0cab13ed3419';
      var jQuery = null;
      ...
      function addButtonToPopover() {
        var $item = jQuery('.changeFieldValue.' + hashTryReachField + ' .item');
        $item.find('.valueWrap').prepend("\n\t\t        <div style=\"display:flex;justify-content:space-between;margin-bottom:3px;\">\n\t\t            <button style=\"padding:5px 10px;cursor: pointer;\" class=\"sub-one-tryreach\">-1</button>\n\t\t            <button style=\"padding:5px 10px;cursor: pointer;\" class=\"add-one-tryreach\">+1</button>\n\t\t        </div>\n\t\t    ");
        $item.find('.select2-container').hide();
        $item.find('select').removeClass('select2-offscreen');
      }

      function subOneTryReach($item) {
        var $select = $item.find('select[name="' + hashTryReachField + '"]');
        var index = $select.prop('selectedIndex');
  ...
  return _createClass(ReachCounter2);
}(_TamperController__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ReachCounter2);

/***/ }),

/***/ "./src/lib/controller/TamperController.ts":
/*!************************************************!*\
  !*** ./src/lib/controller/TamperController.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _config_routes_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../config/routes.json */ "./src/lib/config/routes.json");
/* harmony import */ var _controller_TamperController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../controller/TamperController */ "./src/lib/controller/TamperController.ts");
/* harmony import */ var uri_template_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! uri-template-router */ "./node_modules/uri-template-router/index.js");
/* harmony import */ var _TamperRequest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TamperRequest */ "./src/lib/core/router/TamperRequest.ts");
...
var TamperRouter = /*#__PURE__*/_createClass(function TamperRouter() {
  ...
  _defineProperty(this, "init", function () {
    _this.configRoutes = _config_routes_json__WEBPACK_IMPORTED_MODULE_0__.routes;
  ...
  _defineProperty(this, "_checkRoute", function (name, patterns, action, debug) {
    ...
    for (var r = 0; r < patterns.length; r++) {
      _this.router.addTemplate(patterns[r], {}, name);
    ...
    if (resolvedRouter || debug) {
      ...
      _this._instanciateController(controllerDirectory, controllerName, new _TamperRequest__WEBPACK_IMPORTED_MODULE_3__["default"](resolvedRouter));
    }
  });

  _defineProperty(this, "_instanciateController", function (directory, name, request) {
    __webpack_require__("./src/lib/controller eager recursive ^\\.\\/.*$")("./".concat(directory, "/").concat(name, "/").concat(name)).then(function (module) {
      ...
      if (parent !== _controller_TamperController__WEBPACK_IMPORTED_MODULE_1__["default"].name) {
  ...
  this.controllers = {};
  this.router = new uri_template_router__WEBPACK_IMPORTED_MODULE_2__.Router();
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _core_router_TamperRouter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/router/TamperRouter */ "./src/lib/core/router/TamperRouter.ts");
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var App = /*#__PURE__*/_createClass(function App() {
  ...
  this.router = new _core_router_TamperRouter__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
...
document.querySelector("body").innerHTML = "<h1>".concat(title, "</h1>"); // App section

var app = new _lib__WEBPACK_IMPORTED_MODULE_0__["default"]();
app.init();
})();
