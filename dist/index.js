...
/***/ "./src/lib/controller/Github/ProjectRepository/ProjectRepository.ts":
/*!**************************************************************************!*\
  !*** ./src/lib/controller/Github/ProjectRepository/ProjectRepository.ts ***!
  \**************************************************************************/
...
/* harmony export */ });
/* harmony import */ var core_controller_TamperController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core/controller/TamperController */ "./src/lib/core/controller/TamperController.ts");
...
var ProjectRepository = /*#__PURE__*/function (_TamperController) {
  _inherits(ProjectRepository, _TamperController);

  var _super = _createSuper(ProjectRepository);
  ...
  return _createClass(ProjectRepository);
}(core_controller_TamperController__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProjectRepository);

/***/ }),

/***/ "./src/lib/controller/Pipedrive/Asana/RoadmapProduitTools.ts":
/*!*******************************************************************!*\
  !*** ./src/lib/controller/Pipedrive/Asana/RoadmapProduitTools.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var RoadmapProduitTools = /*#__PURE__*/function (_TamperController) {
  _inherits(RoadmapProduitTools, _TamperController);

  var _super = _createSuper(RoadmapProduitTools);

  function RoadmapProduitTools() {
    var _this;

    _classCallCheck(this, RoadmapProduitTools);
  ...
  return _createClass(RoadmapProduitTools);
}(core_controller_TamperController__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RoadmapProduitTools);

/***/ }),

/***/ "./src/lib/controller/Pipedrive/BackstageTools/BackstageTools.ts":
/*!***********************************************************************!*\
  !*** ./src/lib/controller/Pipedrive/BackstageTools/BackstageTools.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var core_controller_TamperController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core/controller/TamperController */ "./src/lib/core/controller/TamperController.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var BackstageTools = /*#__PURE__*/function (_TamperController) {
  _inherits(BackstageTools, _TamperController);

  var _super = _createSuper(BackstageTools);

  function BackstageTools() {
    var _this;

    _classCallCheck(this, BackstageTools);
    ...
    _defineProperty(_assertThisInitialized(_this), "run", function (request) {
      _this.stealthPopupListener();

      _this.personSyncAction();
    });

    _defineProperty(_assertThisInitialized(_this), "stealthPopupListener", function (ms) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.stealth-popup-opener', function (event) {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target);
        var win = window.open($this.data('url'), '_', 'menubar=no, status=no, scrollbars=no, menubar=no, width=1, height=1');
        setTimeout(function () {
          if (win) {
            win.close();
          }
    ...
    _defineProperty(_assertThisInitialized(_this), "personSyncAction", function () {
      var checkKey = 'personSyncAction';
      var anchor = '.widget.personFields.fieldsView:visible';

      _this.checkFor(checkKey, function () {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()(anchor).length !== 0;
      }, function (elementMarker) {
        elementMarker(jquery__WEBPACK_IMPORTED_MODULE_0___default()(anchor).eq(0)[0]);
        var syncUrl = 'https://backstage.santeacademie.com/customer/contact/connector-sync/pipedrive/__email__';
        syncUrl = syncUrl.replace('__email__', jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-test=email-label]').eq(0).text().trim().replace(/(.+)\((.+)\)/, '$1'));
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(anchor).prepend('<div class="columnTitle"><a href="javascript:void(0);" class="stealth-popup-opener" data-url="' + syncUrl + '">Synchroniser depuis Backstage</a></div>');
      }, 500);
    });
  ...
  return _createClass(BackstageTools);
}(core_controller_TamperController__WEBPACK_IMPORTED_MODULE_1__["default"]);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BackstageTools);

/***/ }),

/***/ "./src/lib/controller/Pipedrive/ReachCounter/ReachCounter.ts":
/*!*******************************************************************!*\
  !*** ./src/lib/controller/Pipedrive/ReachCounter/ReachCounter.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ReachCounter = /*#__PURE__*/function (_TamperController) {
  _inherits(ReachCounter, _TamperController);

  var _super = _createSuper(ReachCounter);

  function ReachCounter() {
    var _this;

    _classCallCheck(this, ReachCounter);
    ...
    _defineProperty(_assertThisInitialized(_this), "buttonAdded", false);

    _defineProperty(_assertThisInitialized(_this), "focusedFieldKey", undefined);

    _defineProperty(_assertThisInitialized(_this), "run", function (request) {
      setTimeout(function () {
        _this._launchTryReach();
      }, 3500);
    });

    _defineProperty(_assertThisInitialized(_this), "_grabFieldKey", function (regexField, searchFieldKey) {
      var foundField = undefined;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gridHeader__cell').each(function (index, element) {
        if (foundField) {
          return;
        }

        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).text().trim().match(regexField)) {
          var field = jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).data().field;
    ...
    _defineProperty(_assertThisInitialized(_this), "_launchTryReach", function () {
      if (_this.loaded === true) {
        return;
      }

      var $body = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body');
      $body.on('click', 'td.gridRow__cell:not(".gridRow__cell--editing") button', function (event) {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target);
        _this.focusedFieldKey = _this._grabFieldKey(/^tentative/i, $this.parents('td:eq(0)').data('field'));

        if (_this.focusedFieldKey) {
          setTimeout(function () {
            _this._addButtonToPopover();

            _this.buttonAdded = true;
          }, _this.buttonAdded ? 100 : 1000);
        }
      });
      $body.on('click', '.sub-one-tryreach', function (event) {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target);

        _this._subOneTryReach($this.closest('.item'));
      });
      $body.on('click', '.add-one-tryreach', function (event) {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target);

        _this._addOneTryReach($this.closest('.item'));
      });
      _this.loaded = true;
    });

    _defineProperty(_assertThisInitialized(_this), "_addButtonToPopover", function () {
      var $item = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.changeFieldValue.' + _this.focusedFieldKey + ' .item');
    ...
    _defineProperty(_assertThisInitialized(_this), "_subOneTryReach", function ($item) {
      var $select = $item.find('select[name="' + _this.focusedFieldKey + '"]');
    ...
    _defineProperty(_assertThisInitialized(_this), "_addOneTryReach", function ($item) {
      var $select = $item.find('select[name="' + _this.focusedFieldKey + '"]');
      var index = $select.prop('selectedIndex');
  ...
  return _createClass(ReachCounter);
}(core_controller_TamperController__WEBPACK_IMPORTED_MODULE_1__["default"]);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ReachCounter);

/***/ }),

/***/ "./src/lib/core/controller/TamperController.ts":
/*!*****************************************************!*\
  !*** ./src/lib/core/controller/TamperController.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var core_waiter_WaiterScheduler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core/waiter/WaiterScheduler */ "./src/lib/core/waiter/WaiterScheduler.ts");
/* harmony import */ var core_presence_PresenceScheduler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core/presence/PresenceScheduler */ "./src/lib/core/presence/PresenceScheduler.ts");
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var TamperController = /*#__PURE__*/_createClass(function TamperController() {
  _classCallCheck(this, TamperController);

  _defineProperty(this, "waitFor", function (readyCallback, ms) {
    return new core_waiter_WaiterScheduler__WEBPACK_IMPORTED_MODULE_0__["default"](ms).waitForChecker(readyCallback);
  });

  _defineProperty(this, "checkFor", function (checkKey, readyCallback, processCallback, ms) {
    return new core_presence_PresenceScheduler__WEBPACK_IMPORTED_MODULE_1__["default"](checkKey, ms).waitForChecker(readyCallback, processCallback);
  });
});

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TamperController);

/***/ }),

/***/ "./src/lib/core/presence/PresenceScheduler.ts":
/*!****************************************************!*\
  !*** ./src/lib/core/presence/PresenceScheduler.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _PresenceState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PresenceState */ "./src/lib/core/presence/PresenceState.ts");
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var PresenceScheduler = /*#__PURE__*/_createClass(function PresenceScheduler(checkKey, ms) {
  var _this = this;

  _classCallCheck(this, PresenceScheduler);

  _defineProperty(this, "ms", void 0);

  _defineProperty(this, "checkKey", void 0);

  _defineProperty(this, "presenceState", void 0);

  _defineProperty(this, "presenceInterval", void 0);

  _defineProperty(this, "_startWaitLoop", function () {
    return setInterval(function () {
      if (!_this.presenceState.checker()) {
        return;
      }

      var foreverComputedPair = PresenceScheduler.FOREVER_ATTRIBUTE_NAME + '="' + _this.checkKey + '"';
      var checkKeyInstances = document.querySelectorAll('[' + foreverComputedPair + ']');
      var present = false;

      for (var i = 0; i < checkKeyInstances.length; i++) {
        var el = checkKeyInstances[i];
      ...
      if (!present) {
        _this.presenceState.processor(function (element) {
          element.setAttribute(PresenceScheduler.FOREVER_ATTRIBUTE_NAME, _this.checkKey || '');
        });
      }
    }, _this.ms);
  });

  _defineProperty(this, "waitForChecker", function (readyCallback, processCallback) {
    _this.presenceState.checker = readyCallback;
    _this.presenceState.processor = processCallback;
  });

  this.checkKey = checkKey;
  this.ms = ms || 100;
  this.presenceState = new _PresenceState__WEBPACK_IMPORTED_MODULE_0__["default"]();
  this.presenceInterval = this._startWaitLoop();
});

_defineProperty(PresenceScheduler, "FOREVER_ATTRIBUTE_NAME", 'wait-forever');

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PresenceScheduler);

/***/ }),

/***/ "./src/lib/core/presence/PresenceState.ts":
/*!************************************************!*\
  !*** ./src/lib/core/presence/PresenceState.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var PresenceState = /*#__PURE__*/_createClass(function PresenceState(checker, processor) {
  _classCallCheck(this, PresenceState);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PresenceState);

/***/ }),

/***/ "./src/lib/core/router/TamperRequest.ts":
/*!**********************************************!*\
  !*** ./src/lib/core/router/TamperRequest.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var TamperRequest = /*#__PURE__*/_createClass(function TamperRequest(result) {
  _classCallCheck(this, TamperRequest);
  ...
  _defineProperty(this, "uriTemplate", void 0);

  _defineProperty(this, "route", void 0);

  _defineProperty(this, "router", void 0);

  this.routeName = (result === null || result === void 0 ? void 0 : result.matchValue) || '';
  this.params = (result === null || result === void 0 ? void 0 : result.params) || {};
  this.uri = (result === null || result === void 0 ? void 0 : result.uri) || '';
  this.uriTemplate = (result === null || result === void 0 ? void 0 : result.uriTemplate) || '';
  this.route = (result === null || result === void 0 ? void 0 : result.route) || null;
  this.router = (result === null || result === void 0 ? void 0 : result.router) || null;
});

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TamperRequest);

/***/ }),

/***/ "./src/lib/core/router/TamperRouter.ts":
/*!*********************************************!*\
  !*** ./src/lib/core/router/TamperRouter.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var uri_template_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uri-template-router */ "./node_modules/uri-template-router/index.js");
/* harmony import */ var config_routes_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! config/routes.json */ "./src/lib/config/routes.json");
/* harmony import */ var core_controller_TamperController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core/controller/TamperController */ "./src/lib/core/controller/TamperController.ts");
/* harmony import */ var core_router_TamperRequest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core/router/TamperRequest */ "./src/lib/core/router/TamperRequest.ts");
...
var TamperRouter = /*#__PURE__*/_createClass(function TamperRouter() {
  var _this = this;

  _classCallCheck(this, TamperRouter);

  _defineProperty(this, "configRoutes", void 0);
  ...
  _defineProperty(this, "init", function () {
    _this.configRoutes = config_routes_json__WEBPACK_IMPORTED_MODULE_1__.routes;

    _this.configRoutes.forEach(function (route) {
      _this._checkRoute(route.name, route.patterns, route.action, route.debug);
    });
  });

  _defineProperty(this, "_checkRoute", function (name, patterns, action, debug) {
    var _routes$debug$url, _routes$debug$url2;

    _this.debugMode = ((_routes$debug$url = config_routes_json__WEBPACK_IMPORTED_MODULE_1__.debug.url) !== null && _routes$debug$url !== void 0 ? _routes$debug$url : undefined) !== undefined;
    var url = (_routes$debug$url2 = config_routes_json__WEBPACK_IMPORTED_MODULE_1__.debug.url) !== null && _routes$debug$url2 !== void 0 ? _routes$debug$url2 : document.location.href;
    ...
    for (var r = 0; r < patterns.length; r++) {
      ...
      _this.router.addTemplate(pattern['pattern'], {}, name);

      resolvedRouter = _this.router.resolveURI(url);
    ...
    if (resolvedRouter || debug) {
      var _action$split = action.split(':'),
          ...
          controllerDirectory = _action$split2[0],
          controllerName = _action$split2[1];

      _this._instantiateController(controllerDirectory, controllerName, new core_router_TamperRequest__WEBPACK_IMPORTED_MODULE_3__["default"](resolvedRouter));
    }
  });

  _defineProperty(this, "_instantiateController", function (directory, name, request) {
    __webpack_require__("./src/lib/controller eager recursive ^\\.\\/.*$")("./".concat(directory, "/").concat(name, "/").concat(name)).then(function (module) {
      var instance = new module["default"]();
      var parent = Object.getPrototypeOf(Object.getPrototypeOf(instance)).constructor.name;

      if (parent !== core_controller_TamperController__WEBPACK_IMPORTED_MODULE_2__["default"].name) {
        throw new Error("Controller ".concat(directory, ":").concat(name, " is not a TamperController"));
      }

      if (!instance.run) {
        throw new Error("Controller ".concat(directory, ":").concat(name, " has no 'run' method"));
      }

      console.debug("Invoke ".concat(directory, ":").concat(name, " controller"));
      _this.controllers[name] = instance;
      instance.run(request);
    });
  });

  this.controllers = {};
  this.router = new uri_template_router__WEBPACK_IMPORTED_MODULE_0__.Router();
  this.debugMode = false;
});

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TamperRouter);

/***/ }),

/***/ "./src/lib/core/waiter/WaiterScheduler.ts":
/*!************************************************!*\
  !*** ./src/lib/core/waiter/WaiterScheduler.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _WaiterState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WaiterState */ "./src/lib/core/waiter/WaiterState.ts");
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var WaiterScheduler = /*#__PURE__*/_createClass(function WaiterScheduler(ms) {
  var _this = this;

  _classCallCheck(this, WaiterScheduler);

  _defineProperty(this, "ms", void 0);

  _defineProperty(this, "waiterState", void 0);

  _defineProperty(this, "waiterInterval", void 0);

  _defineProperty(this, "_startWaitLoop", function () {
    return setInterval(function () {
      if (!_this.waiterState.checker()) {
        return;
      }

      _this.waiterState.resolver();

      clearInterval(_this.waiterInterval);
    }, _this.ms);
  });

  _defineProperty(this, "waitForChecker", function (readyCallback) {
    _this.waiterState.checker = readyCallback;
    return new Promise(function (resolve) {
      _this.waiterState.resolver = resolve;
    });
  });

  this.ms = ms || 100;
  this.waiterState = new _WaiterState__WEBPACK_IMPORTED_MODULE_0__["default"]();
  this.waiterInterval = this._startWaitLoop();
});

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WaiterScheduler);

/***/ }),

/***/ "./src/lib/core/waiter/WaiterState.ts":
/*!********************************************!*\
  !*** ./src/lib/core/waiter/WaiterState.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var WaiterState = /*#__PURE__*/_createClass(function WaiterState(checker, resolver) {
  _classCallCheck(this, WaiterState);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WaiterState);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var core_router_TamperRouter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core/router/TamperRouter */ "./src/lib/core/router/TamperRouter.ts");
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var App = /*#__PURE__*/_createClass(function App() {
  ...
  this.router = new core_router_TamperRouter__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
...
/***/ "./node_modules/uri-template-router/index.js":
/*!***************************************************!*\
  !*** ./node_modules/uri-template-router/index.js ***!
  \***************************************************/
/***/ ((module) => {
...
/***/ "./src/lib/controller eager recursive ^\\.\\/.*$":
/*!*************************************************************!*\
  !*** ./src/lib/controller/ eager ^\.\/.*$ namespace object ***!
  \*************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var map = {
	"./Github/ProjectRepository/ProjectRepository": "./src/lib/controller/Github/ProjectRepository/ProjectRepository.ts",
	"./Github/ProjectRepository/ProjectRepository.ts": "./src/lib/controller/Github/ProjectRepository/ProjectRepository.ts",
	"./Pipedrive/Asana/RoadmapProduitTools": "./src/lib/controller/Pipedrive/Asana/RoadmapProduitTools.ts",
	"./Pipedrive/Asana/RoadmapProduitTools.ts": "./src/lib/controller/Pipedrive/Asana/RoadmapProduitTools.ts",
	"./Pipedrive/BackstageTools/BackstageTools": "./src/lib/controller/Pipedrive/BackstageTools/BackstageTools.ts",
	"./Pipedrive/BackstageTools/BackstageTools.ts": "./src/lib/controller/Pipedrive/BackstageTools/BackstageTools.ts",
...
"use strict";
module.exports = JSON.parse('{"debug":{"url":"https://app.asana.com/0/1201126223006976/list"},"routes":[{"name":"pipedrive_reach_counter","patterns":[{"protocol":"https","host":"santeacademie.pipedrive.com","pattern":"https://santeacademie.pipedrive.com{/path*}"}],"action":"Pipedrive:ReachCounter","debug":false},{"name":"pipedrive_backstage_tools","patterns":[{"protocol":"https","host":"santeacademie.pipedrive.com","pattern":"https://santeacademie.pipedrive.com/person{/personId}{/path*}"}],"action":"Pipedrive:BackstageTools","debug":false},{"name":"asana_roadmap_produit_tools","patterns":[{"protocol":"https","host":"app.asana.com","pattern":"https://app.asana.com/0/1201126223006976/list{/path*}"}],"action":"Asana:RoadmapProduitTools","debug":false},{"name":"github_project_repository","patterns":[{"protocol":"https","host":"github.com","pattern":"https://github.com/orgs{/orgName}/projects{/projectId}{/path*}"}],"action":"Github:ProjectRepository","debug":false}]}');
...
var title = 'BigBrowser - Sandbox';
document.title = title;
var body = document.querySelector("body");

if (body) {
  body.innerHTML = "<h1>".concat(title, "</h1>");
}
